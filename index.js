...
dust.loadSource(dust.compile(require('./template'), 'hub-configs-main'));
dust.loadSource(dust.compile(require('./list'), 'hub-configs-list'));
dust.loadSource(dust.compile(require('./add'), 'hub-configs-add'));
dust.loadSource(dust.compile(require('./details'), 'hub-configs-details'));
